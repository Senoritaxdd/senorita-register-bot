...
module.exports = {
    ...
    execute: async (client, message, args, embed, author, channel, guild) => {
        ...
        await guild.members.cache.get(member.id).roles.add("937698195855773725");
        ...
        client.channels.cache.get(config.channels.chat).send(`${member} sunucuya kayıt oldu. Aramıza hoş geldin! <#937698196866625623>ımızı okuduktan sonra, <#937698197109874764> - <#937698197109874766> kanallarından rollerini almayı unutma.`);
    }
}