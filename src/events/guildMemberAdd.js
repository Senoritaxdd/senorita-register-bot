...
module.exports = async member => {
    ...
    if (kurulus > 604800000) {
        ...
        member.guild.channels.cache.get(config.channels.welcomechannel).send(`<a:konfetigif:937714799582785557> Sunucumuza hoş geldin ${member}!
